...
<title>Laboratoire de recherche ISDM- Accueil</title>
       ...
       <?php include('includes/header.php') ?>
        ...
        <main class="main-content">
            <!-- banner-section -->
             <!-- <section class="banner-section" >
                <div class="banner-image">
                    <img src="assets/images/banner/1.jpg" alt="Background Image">
                </div>
             </section> -->
            <section class="banner-section p_relative">
                <div class="banner-carousel owl-theme owl-carousel owl-dots-none owl-nav-none">
                    <div class="slide-item p_relative">
                        <div class="bg-layer" style="background-image: url(assets/images/banner/2.jpg);"></div>
                    ...
                    <div class="slide-item p_relative">
                        <div class="bg-layer" style="background-image: url(assets/images/banner/1.jpg);"></div>
                        <div class="pattern-layer" style="background-image: url(assets/images/shape/shape-1.png);"></div>
                        <div class="auto-container">
                            <div class="content-box p_relative d_block z_5">
                                <span class="sub-title">Laboratory</span>
                            ...
                            <div class="content_block_one">
                                <div class="content-box ml_30 sec-title-animation animation-style2">
                                    <div class="sec-title mb_25">
                                        <span class="sub-title mb_20 title-animation">Laboratory</span>
                                        <h2 class="title-animation">We Provide Reliable & High-Quality Clinical Service</h2>
                                    </div>
                                    <div class="text-box mb_45 title-animation">
                                        <p>Welcome to the Labout Rare Chemistry Research Documentation Center, a hub exploration & discovery in the realm of uncommon & extraordinary chemical phenomena.</p>
            ...
            <section class="funfact-section pt_130 pb_120 centred">
                ...
                <div class="auto-container">
                    <div class="sec-title light mb_70 sec-title-animation animation-style2">
                        <span class="sub-title mb_20 title-animation">Laboratory</span>
                        <h2 class="title-animation">We Provide Reliable & High</h2>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="service-details.html">Potable Water and Waste</a></h3>
                                    <p>Potable water treatment processes remove impurities, contaminants, and pathogens.</p>
                                    <div class="link"><a href="service-details.html">Discover More <i class="fal fa-angle-right"></i></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="service-details.html">Cooling Water Treatment</a></h3>
                                    <p>After treatment, potable water is distribute through well maintained systems of pipes.</p>
                                    <div class="link"><a href="service-details.html">Discover More <i class="fal fa-angle-right"></i></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="service-details.html">Magnetometry Transport</a></h3>
                                    <p>Protecting water sources, such as rivers, lakes, and aquifers, is critical for maintain.</p>
                                    <div class="link"><a href="service-details.html">Discover More <i class="fal fa-angle-right"></i></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="service-details.html">X-Ray Diffraction</a></h3>
                                    <p>The key principle behind XRD is Bragg's Law, formulated by Sir William Braggers.</p>
                                    <div class="link"><a href="service-details.html">Discover More <i class="fal fa-angle-right"></i></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-one">
                                <div class="inner-box">
                                    ...
                                    <h3><a href="service-details.html">Mass Chemical Analysis</a></h3>
                                    <p>Regular monitoring & analysis condensate quality are essential conductivity.</p>
                                    <div class="link"><a href="service-details.html">Discover More <i class="fal fa-angle-right"></i></a></div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="working-section centred pt_120 pb_80">
                <div class="bg-layer parallax-bg" data-parallax='{"y": 100}' style="background-image: url(assets/images/background/working-bg.jpg);"></div>
                <div class="auto-container">
                    <div class="sec-title light mb_60 sec-title-animation animation-style2">
                        ...
                        <h2 class="title-animation">Our Working Process</h2>
                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 working-block">
                                <div class="working-block-one">
                                    <div class="inner-box">
                                        ...
                                        <h3>Client Briefs Project</h3>
                                        <p>The more details you can provide, the better lab can assist you</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 working-block">
                                <div class="working-block-one">
                                    <div class="inner-box">
                                        ...
                                        <h3>Lab Generates Proposal</h3>
                                        <p>Provide information on how the client can proceed with the proposal</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 working-block">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-6 col-sm-12 events-block">
                            <div class="events-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="events-details.html"><img src="assets/images/resource/events-1.jpg" alt=""></a></figure>
                                    <div class="lower-content">
                                        <div class="post-date"><h2>24<span>Jun</span></h2></div>
                                        <span class="location-box"><i class="icon-18"></i>United State</span>
                                        <h3><a href="events-details.html">Freshly Cosmetics Payments Makeover</a></h3>
                                        <p>The Information technology and software in development Problems solutions.</p>
                                        <div class="speakers-box">
                                            <ul class="speakers-list">
                                                <li><img src="assets/images/resource/speakers-1.png" alt=""></li>
                                                <li><img src="assets/images/resource/speakers-2.png" alt=""></li>
                                                <li><img src="assets/images/resource/speakers-3.png" alt=""></li>
                                            </ul>
                                            <div class="text">
                                                <h6>10+</h6>
                                                <span>Speakers</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 events-block">
                            <div class="events-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="events-details.html"><img src="assets/images/resource/events-2.jpg" alt=""></a></figure>
                                    <div class="lower-content">
                                        <div class="post-date"><h2>12<span>Mar</span></h2></div>
                                        <span class="location-box"><i class="icon-18"></i>United State</span>
                                        <h3><a href="events-details.html">Organic Chemistry Research Laboratory</a></h3>
                                        <p>Managing interactions customers throughout the entire customer lifecycle of the deal.</p>
                                        <div class="speakers-box">
                                            <ul class="speakers-list">
                                                <li><img src="assets/images/resource/speakers-1.png" alt=""></li>
                                                <li><img src="assets/images/resource/speakers-2.png" alt=""></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 events-block">
                            <div class="events-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="events-details.html"><img src="assets/images/resource/events-3.jpg" alt=""></a></figure>
                                    <div class="lower-content">
                                        <div class="post-date"><h2>16<span>Feb</span></h2></div>
                                        <span class="location-box"><i class="icon-18"></i>United State</span>
                                        <h3><a href="events-details.html">The research team is filled with multidisciplinary</a></h3>
                                        <p>The systematic investigation and experiment to develop new products, processes improve</p>
                                        <div class="speakers-box">
                                            <ul class="speakers-list">
                                                <li><img src="assets/images/resource/speakers-1.png" alt=""></li>
                                                <li><img src="assets/images/resource/speakers-2.png" alt=""></li>
            ...
            <section class="cta-section">
                <div class="auto-container">
                    <div class="inner-container">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 cta-block">
            ...
            <section class="team-section pt_120 pb_90 centred">
                <div class="bg-layer" style="background-image: url(assets/images/background/team-bg.png);"></div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                            <div class="team-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="team-details.html">Theresa Webb</a></h3>
                                        <span class="designation">Physician</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="team-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <span class="designation">Chemist</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <span class="designation">DNA Developer</span>
                                    </div>
                                </div>
                            </div>
                        </div>

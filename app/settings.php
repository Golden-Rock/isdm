...
<section class="content home">
    <div class="block-header">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                <small>Bienvenue sur Isdm</small>
                </h2>
            </div>      
            <?php /*      
            <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                <div class="inlineblock text-center m-r-15 m-l-15 d-none d-lg-inline-block">
                    ...
                    <small class="col-white">Visiteurs</small>
                </div>
                <div class="inlineblock text-center m-r-15 m-l-15 d-none d-lg-inline-block">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="home"><i class="zmdi zmdi-home"></i>Yemak</a></li>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-6" style="border-radius: 10px 10px 10px 10px;" >
                <div class="card">
                    <a href="add_isdm_member" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-edit"></i> Ajouter un Membre </a>
                    <a href="all_isdm_team" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-library"></i> Voir la team ISDM</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card">
                    <a href="add_video" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-edit"></i> Ajouter une vidéo</a>
                    <a href="add_video" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-label"></i> Voir les vidéos</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card">
                    <a href="add_categorie" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-edit"></i> Ajouter une Catégorie</a>
                    <a href="" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-lamp"></i> Voir les Catégories</a>
                </div>
            </div>
            */ ?>
            <div class="col-lg-4 col-md-6">
                <div class="card">
                <a href="" class="t-dark btn btn-primary btn-simple btn-round btn-block">
                    <i class="zmdi zmdi-account-o"></i> Information du profil</a>
                </div>
            </div>
        </div>
        <?php /*

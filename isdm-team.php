                            ...
                            <div class="service-sidebar mr_20">
                                <div class="category-widget sidebar-widget mb_30">
                                    ...
                                    <div class="widget-content">
                                        ...
                                        <li><a href="#" class="current">ISDM Team</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="auto-container">
                                ...
                                <div class="row clearfix">
                                    <?php 
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 team-block">
                                            <div class="team-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                                                <div class="inner-box">
                                                    ...
                                                    <div class="lower-content">
                                                        <h3><a href="isdm-team/<?php echo $data['mat_member'] ?>"><?php echo $data['title_member'] ?> <?php echo $data['first_name'] ?> <?php echo $data['last_name'] ?></a></h3>
